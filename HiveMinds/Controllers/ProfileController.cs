...
public class ProfileController : Controller
{
    ...
    public ProfileController(IThoughtService thoughtRepo, IAccountRepository accountRepo, IAuthService auth, ILogger<HomeController> logger, IUtility utility, IVerificationService verification)
    {
